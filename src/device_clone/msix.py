...
This module contains classes for managing MSI-X capability data preloading
and injection during device cloning operations.
"""
...
# Config space path template for sysfs access
