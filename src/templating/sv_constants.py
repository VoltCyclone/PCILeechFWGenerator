...
class SVTemplates:
    """Template paths for SystemVerilog generation - Config-only architecture."""

    # Configuration templates only - no HDL generation
    DEVICE_CONFIG: str = "sv/device_config.sv.j2"
    PCILEECH_CFGSPACE: str = "sv/pcileech_cfgspace.coe.j2"
    PCILEECH_HEADER: str = "sv/pcileech_header.svh.j2"
    
    # Integration scripts
    BUILD_INTEGRATION: str = "python/build_integration.py.j2"
    PCILEECH_INTEGRATION: str = "python/pcileech_build_integration.py.j2"
    
    # Config-only modules list
    CONFIG_MODULES: List[str] = [
        "device_config.sv.j2",
        "pcileech_cfgspace.coe.j2",
    ]
